...
public class Ev implements Annotation {
    ...
    public Ev(ConceptInfo conceptInfo, String matchedText, String conceptString, int start, int length,
            double scoreValue, String partOfSpeech) {
    ...
    public Ev(ConceptInfo conceptInfo, String matchedText, String conceptString, int start, int length,
            double scoreValue, String partOfSpeech, int beginTokenIndex, int endTokenIndex) {
        this.conceptInfo = conceptInfo;
        this.matchedText = matchedText.intern();
        this.conceptString = conceptString.intern();
        this.start = start;
    ...
    public String toString() {
        ...
        sb.append("|").append(this.beginTokenIndex).append(":").append(this.endTokenIndex).append("|");
        sb.append(this.conceptInfo.toString().replace("|", "+"));
        return sb.toString();
    }

    public boolean equals(Object obj) {
        return (((Ev) obj).start == this.start) && (((Ev) obj).length == this.length)
