...
/**
 * EntityLookup4 - Entity Lookup of text segments - sentences, lines, or other
...
public class EntityLookup4 implements EntityLookup {
    ...
    public EntityLookup4(Properties properties) throws IOException, FileNotFoundException {
    ...
    public void addEvSetToSpanMap(Map<String, Entity> spanMap, Set<Ev> evSet, String docid, String fieldid,
            String matchedText, String lexicalCategory, int sentenceNumber, int offset, int length, int begTok, int endTok) {
    ...
    public SpanEntityMapAndTokenLength findLongestMatch(String docid, String fieldid, int sentenceNumber,
            List<ERToken> tokenList) throws FileNotFoundException, IOException {
        ...
        for (List<? extends Token> tokenSubList : listOfTokenSubLists) {
            ...
            if ((!firstToken.getText().toLowerCase().equals("other"))
                ...
                int beginTokenIndex = firstToken.getIndex();
                int endTokenIndex = lastToken.getIndex();
                        ...
                        for (ConceptInfo concept : conceptInfoSet) {
                            ...
                            if (!this.excludedTerms.isExcluded(cui, normTerm)) {
                                Ev ev = new Ev(concept, originalTerm, normTerm,
                                        ...
                                        ((ERToken) tokenSubList.get(0)).getPartOfSpeech(), beginTokenIndex, endTokenIndex);
                        ...
                        if (evSet.size() > 0) {
                            this.addEvSetToSpanMap(spanMap, evSet, docid, fieldid, originalTerm,
                                    ((ERToken) tokenSubList.get(0)).getPartOfSpeech(), // should this be noun/verb/adj
                                                                                       // phrase?
                                    sentenceNumber, offset, termLength, beginTokenIndex, endTokenIndex);
        ...
        try {
            ...
            for (BioCSentence sentence : passage.getSentences()) {
                ...
                Set<Entity> abbrevEntitySet = new HashSet(
                        MarkAbbreviations.markAbbreviations(passage, this.uaMap, new ArrayList(entitySet0)));
                // dbg
